...
id,id2,loop,ok,cp,akun,oprek,method,lisensiku,taplikasi,tokenku,uid,lisensikuni,cokbrut,princp,pwpluss,okc,cpc= [],[],0,0,0,[],[],[],[],[],[],[],[],[],[],[],[],[]
...
def dump_publik():
	...
	try:
		koh2 = requests.get('https://graph.facebook.com/v1.0/'+pil+'?fields=friends.limit(5000)&access_token='+tokenku[0]).json()
...
def dump_likes():
	...
	try:
		koh2 = requests.get('https://graph.facebook.com/v1.0/'+pil+'?fields=likes.limit(10000)&access_token='+tokenku[0]).json()
